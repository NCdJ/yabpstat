...
1. Using YABPstat «*ya_search*» to get results for the query for "ihpc" (_Harmonised index of consumer prices_), and returning the results in portuguese language.
...
2. Using YABPstat «*ya_info_serie()*» to plot a serie from BPstat in english language.
...
3. Using YABPstat «*ya_info_serie()*» to view the data from a BPstat serie in a table format in english language.
...
4. Using YABPstat «*ya_info_serie()*» to use the data from a BPstat serie in a dataframe format for use in further analysis and reuse.
